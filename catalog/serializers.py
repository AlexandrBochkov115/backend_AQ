...
class ProductImageSerializer(serializers.ModelSerializer):
    ...
    def validate_image(self, value):
        ...
        try:
            ...
            img.verify()
            value.seek(0)  # Возвращаем указатель файла в начало
        except Exception:
...
class ProductSerializer(serializers.ModelSerializer):
    ...
    category = CategorySerializer(read_only=True)  # Добавлено для отображения категории
    ...
    def validate(self, data):
        ...
        # Проверка уникальности slug в категории
    ...
    def update(self, instance, validated_data):
        ...
        if 'specifications' in self.initial_data:
